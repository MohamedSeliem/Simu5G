...
// Copyright (C) 2022-2026 Giovanni Nardini, Giovanni Stea et al. (University of Pisa), Mohamed Seliem (University College Cork)
//
...
void LteDlFeedbackGenerator::initialize(int stage)
{
    ...
    if (stage == inet::INITSTAGE_LOCAL) {
        ...
        bool isNr = (strcmp(getFullName(), "nrDlFbGen") == 0 || strcmp(getFullName(), "nrDlFbGen2") == 0);
